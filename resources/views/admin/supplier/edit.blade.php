                        ...
                        <div class="panel-body">
                            <form role="form" action="{{ route('supplier.update',$supplier->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="shopname" value="{{ $supplier->shopname }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword17">Account Holder</label>
                                    <input type="text" class="form-control" name="account_name" value="{{ $supplier->account_name }}" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword41">Account Number</label>
                                    <input type="text" class="form-control" name="account_no" value="{{ $supplier->account_no }}" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <img  src="{{ URL::to($supplier->photo) }}" style="height: 90px; width: 90px;" />
